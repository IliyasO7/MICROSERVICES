...
router.post(
  ...
  [
    ...
    body('servicableCities').isArray().withMessage('Servicable cities are required in an array'),
    body('paymentModes').isArray().withMessage('Payment modes are required in an array'),
