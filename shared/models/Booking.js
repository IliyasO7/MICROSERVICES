...
const schema = new mongoose.Schema(
  {
    ...
    currentBookingType: {
      type: String,
      default: 'TOKEN',
      enum: ['TOKEN', 'SECUIRITY', 'RENT', 'SERVICE'],
      required: true,
    }, //enums dalne hai
    tokenAmount: {
    ...
    serviceCharge: {
      /*status :{ type:String,  default:'UNPAID', enum : ['UNPAID','PAID']}*/ percentage:
        {
          type: Number,
          default: 5,
          enum: [5, 8],
        } /* paymentDue: { type: Date,default:null},paymentId: { type: mongoose.Schema.Types.ObjectId, ref: 'rentalTransactions'}*/,
    },
    securityDeposit: {
      status: { type: String, default: 'UNPAID', enum: ['UNPAID', 'PAID'] },
      amount: { type: Number, default: null },
