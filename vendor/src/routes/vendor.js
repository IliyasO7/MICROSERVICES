...
//login
router.post('/login', validate(validation.vendorlogin), controller.login);

//logout
router.post('/logout', controller.logOut);

//Get profile
router.get('/profile', checkVendorAuth(), controller.profile);
...
//Get List
router.get('/', checkVendorAuth(), controller.list);
// Get order details
router.get('/:orderId', checkVendorAuth(), controller.orderDetails);

//Update Order Price
router.post('/:orderId/updateprice', checkVendorAuth(), controller.updatePrice);
