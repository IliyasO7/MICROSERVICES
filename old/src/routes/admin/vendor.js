...
router.post(
  ...
  [
    ...
    body('additionalPhone').trim().notEmpty().withMessage('Invalid additional mobile number'),
...
router.post(
  ...
  [
    body('ownerName').notEmpty().withMessage('Owner name is required'),
    body('phone').isNumeric().withMessage('Hell').notEmpty().withMessage('Invalid phone number'),
    body('additionalPhone').isNumeric().notEmpty().withMessage('Invalid additional mobile number'),
    body('homeAddress').notEmpty().withMessage('Invalid addresses'),
    body('businessName').notEmpty().withMessage('Invalid business name'),
    body('officeAddress').optional({ nullable: true }),
    body('typeOfVendor').notEmpty().withMessage('Type Of Vendor Required'),
